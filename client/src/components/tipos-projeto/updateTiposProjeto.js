...
const FormTipos = () => {
    ...
    const { tipoProjetoId } = useParams();

    useEffect(() => {
        const url = baseURL + "tipo-projeto/get/" + tipoProjetoId;
        axios.get(url)
            .then((res) => {
                if (res.data.success) {
            ...
            <div className="d-flex align-items-center justify-content-center" style={{ height: "100vh" }}>
                <div className="card">
                    ...
                    <div className="card-body">
                        <form onSubmit={updateTipoProjeto}>
    ...
    async function updateTipoProjeto(event) {
        event.preventDefault();

        try {
            const url = baseURL + "tipo-projeto/update/" + tipoProjetoId;
