                ...
                <div className="rounded p-4 bg-light my-3" style={{ width: '85%' }}>
                    ...
                    <div class='row pt-3'>
                        <div class="col-md-6 form-group pt-2 px-5">
                            <label class="d-flex align-items-center justify-content-center pb-1" for="inputDepartamento">Departamento</label>
                            <select id="inputDepartamento" class="form-select shadow-none " value={Departamento}
                                onChange={(event) => setDepartamento(event.target.value)}>
                                <option value="" selected>Escolha um Departamento:</option>
                                <option value="Web">Web</option>
                                <option value="Cloud">Cloud</option>
                                {/*TO-DO Adicionar mais opções ou carregar de forma dinamica com a bd*/}
                            </select>
                        </div>
                        <div class="col-md-6 form-group pt-2 px-5">
                            <label class="d-flex align-items-center justify-content-center pb-1" for="textAreaContactos">Contactos Adicionais</label>
                            <textarea class="form-control shadow-none" id="textAreaContactos" rows="3" placeholder="Contactos" value={Contactos}
                                onChange={(event) => setContactos(event.target.value)}></textarea>
                        </div>
                    </div>
...
export default FormAdicionarNegocio;
